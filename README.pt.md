...
No Wayland/PipeWire, a captura de áudio é feita por meio da caixa de diálogo do portal de compartilhamento de tela. Quando a caixa de diálogo de compartilhamento aparecer, certifique-se**"Compartilhar áudio"**está marcado. Se o áudio ainda não aparecer após o compartilhamento, o aplicativo tentará automaticamente um fallback de loopback do PipeWire e registrará o resultado.
