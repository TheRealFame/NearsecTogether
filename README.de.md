...
-   **Eingangsisolation**– Strenge Berechtigungen pro Betrachter verhindern, dass Clients unautorisierte Tastatureingaben senden oder Gamepad-Slots überschreiben, die ihnen nicht gehören.
...
Wenn Sie sehen`vulkan_swap_chain.cc Swapchain is suboptimal`oder ähnliche GPU-Abstürze im Terminal auftreten, lehnen Ihre Grafiktreiber die Hardwarebeschleunigungsflags von Electron ab.
